import CallToAction from "./ScreenComponents/CallToAction";
import { filterFoodRecommendations } from "../../helpers/FilterFoodRecommendations";
import { FoodItemPopUp } from "./ScreenComponents/FoodItemPopUp";
import type { FoodItem } from "./ScreenComponents/FoodItemPopUp";
import HeaderSection from "./ScreenComponents/HeaderSection";
import PreferencesForm from "./ScreenComponents/PreferencesForm";
import { useState } from "react";
import FoodRecommendations from "./ScreenComponents/FoodRecommendations";
import ExerciseRecommendations from "./ScreenComponents/ExerciseRecommendations";
import PreferencesSummary from "./ScreenComponents/PreferencesSummary";
...
export function ResultsScreen({ userData, onRestart }: ResultsScreenProps) {
  ...
  const filteredFoods = filterFoodRecommendations(editableUserData, allFoods);
    ...
    <div className="min-h-screen bg-gradient-soft p-4">
      <div className="max-w-6xl mx-auto mt-[5svh]">
        ...
        <div className="text-center mb-12 pt-8">
          ...
          {/* Summary Display */}
          <PreferencesSummary editableUserData={editableUserData} />
          {/* Editable User Form */}
          <PreferencesForm
        ...
        <CallToAction onRestart={onRestart} />
      </div>
